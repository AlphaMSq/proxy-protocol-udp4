...
function packetReceive(msg, rinfo, sendPort) {
    ...
    if (rinfo.address !== serverip) {
        ...
        console.log(type.indexOf('01') != -1, type.indexOf('05') != -1, ipArray[rinfo.port].headerSent == false)
        if (ipArray[rinfo.port].headerSent == false && (type.indexOf('01') != -1 || type.indexOf('05') != -1)) {
